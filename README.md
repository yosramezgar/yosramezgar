...
Ingénieure en développement logiciel spécialisée dans la conception de solutions web modernes et performantes. Passionnée, rigoureuse et orientée expérience utilisateur, je maîtrise plusieurs environnements backend, frontend et DevOps. J’apprends vite, je m’adapte rapidement et j’aime transformer des idées en applications fonctionnelles et intuitives.
...
Conception d’une interface fluide et gestion avancée des stocks.

🖥️ Stagiaire Frontend – NXTYA

📅 Juil 2023 – Août 2023 — Monastir

Développement d’une application de gestion de stock.

Suivi en temps réel et interface dynamique.

🛰️ Stage de Fin d’Études – SOPROCOME

📅 Fév 2022 – Juin 2022 — Sousse

Système de contrôle sécurisé (RFID, caméras, capteurs DHT11).

Monitoring en temps réel et accès sécurisé.

🎓 Formation

🎓 Ingénieure en Génie Logiciel — POLYTECH Monastir (2022–2025)
🎓 Licence Systèmes Embarqués & IoT — ISIMA Mahdia (2019–2022)
🎓 Baccalauréat Mathématique — Bekalta (2019)

🚀 Projets Académiques

Gestion des Incidents Immobiliers — MERN

Système de Gestion Hôtelière — Symfony

Application de Bibliothèque — .NET / C#
